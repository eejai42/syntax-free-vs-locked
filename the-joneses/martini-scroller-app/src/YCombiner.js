...
const YCombiner = ({ externalColor1, externalColor2, onMixedColorChange }) => {
    ...
    const [color2, setColor2] = useState(externalColor2 || '#0000ff');
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', }}>
            <div>
                <table><tr>
                    <td>
                        {externalColor1 ? (
                            <div style={{ width: '200px', height: '200px', backgroundColor: color1 }} />
                        ) : (
                    ...
                    <td>
                        {externalColor2 ? (
                            <div style={{ width: '200px', height: '200px', backgroundColor: color2 }} />
                        ) : (
